...
const Animal = sequelize.define( 'animal', {
    ...
    deleteFlag: {type: DataTypes.BOOLEAN, allowNull: false, defaultValue: false}  //существует
})


const Vaccination = sequelize.define('vaccination', {
    vaccinationId: {type:DataTypes.INTEGER, primaryKey: true, autoIncrement: true},
...
const AnimalVaccination = sequelize.define('animal_x_vaccination', {
    animalVaccinationId: {type:DataTypes.INTEGER, primaryKey: true, autoIncrement: true}, // an_x_vac_id
